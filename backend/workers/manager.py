...
from backend.workers.binance_spot_wsapi import BinanceSpotWsApiUserData
from backend.workers.bybit_user import BybitUserDataWorker

class WorkerManager:
    def __init__(self):
        self.binance_usdt = BinanceUserDataWorker(category="usdt")
        self.binance_spot_wsapi = BinanceSpotWsApiUserData()
    ...
    async def start(self):
        ...
        try:
            await self.binance_spot_wsapi.start()
        except Exception:
    ...
    async def stop(self):
        ...
        await self.binance_spot_wsapi.stop()
